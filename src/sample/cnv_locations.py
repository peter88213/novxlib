"""Import and export noveltree location descriptions for editing. 

Convert noveltree location descriptions to odt with invisible location tags.
Convert html with invisible location tags to noveltree format.
